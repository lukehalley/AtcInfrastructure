# CFN #########################
createStack:
	aws cloudformation create-stack --template-body file://templates/stack.json --stack-name arb-bot --capabilities CAPABILITY_NAMED_IAM

updateStack:
	aws cloudformation update-stack --template-body file://templates/stack.json --stack-name arb-bot --capabilities CAPABILITY_NAMED_IAM
